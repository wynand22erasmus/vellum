# Interface: $ZodNonOptionalInternals\<T\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:941
...
> **def**: [`$ZodNonOptionalDef`]($ZodNonOptionalDef.md)\<`T`\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:942
