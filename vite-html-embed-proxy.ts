/**
 * Shared Vite dev-proxy pipeline for HTML services embedded in dev UI iframes.
 *
 * Applies {@link allowDevIframeEmbed}, buffers HTML responses, reads
 * {@link readResolvedThemeCookie}, and delegates service-specific HTML patches.
 *
...
/**
 * Configure a Vite dev proxy to embed HTML UIs in iframes with theme-aware patching.
 *
 * @param proxy - HTTP proxy instance from Vite `configure`.
 * @param options - HTML patch function applied to each HTML response.
 */
