...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:520

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodTupleInternals`](../namespaces/core/interfaces/$ZodTupleInternals.md)\<`T`, `Rest`\>\>.[`$ZodTuple`](../namespaces/core/interfaces/$ZodTuple.md)\<`T`, `Rest`\>

## Type Parameters

### T

`T` *extends* [`TupleItems`](../namespaces/util/type-aliases/TupleItems.md) = readonly [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)[]

### Rest

`Rest` *extends* [`SomeType`](../namespaces/core/type-aliases/SomeType.md) \| `null` = [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md) \| `null`

## Properties

### ~~\_def~~

> **\_def**: [`$ZodTupleDef`](../namespaces/core/interfaces/$ZodTupleDef.md)\<`T`, `Rest`\>
...
> **\_input**: \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]
...
> **\_output**: \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]
...
> **\_zod**: [`$ZodTupleInternals`](../namespaces/core/interfaces/$ZodTupleInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodTuple`\<`T`, `Rest`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:521
...
> **def**: [`$ZodTupleDef`](../namespaces/core/interfaces/$ZodTupleDef.md)\<`T`, `Rest`\>
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodTuple`\<`T`, `Rest`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodTuple`\<`T`, `Rest`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodTuple`\<`T`, `Rest`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodTuple`\<`T`, `Rest`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodTuple`\<`T`, `Rest`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]
...
(`ctx`) => \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>)[]
...
[`$ZodTupleDef`](../namespaces/core/interfaces/$ZodTupleDef.md)\<`T`, `Rest`\>
...
> **decode**(`data`, `params?`): \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]
...
\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]
...
> **decodeAsync**(`data`, `params?`): `Promise`\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
`Promise`\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
[`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
> **encode**(`data`, `params?`): \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]
...
> **encodeAsync**(`data`, `params?`): `Promise`\<\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>
...
`Promise`\<\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodTuple`\<`T`, `Rest`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodTuple`\<`T`, `Rest`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodTuple`\<`T`, `Rest`\>, `T`\]\>
...
(`x`) => \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]
...
> **parse**(`data`, `params?`): \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]
...
> **parseAsync**(`data`, `params?`): `Promise`\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodTuple`\<`T`, `Rest`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\], `$ZodTypeInternals`\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\], `$ZodTypeInternals`\<`any`, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodTuple`\<`T`, `Rest`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodTuple`\<`T`, `Rest`\> & [`ZodType`](ZodType-1.md)\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\], `$ZodTypeInternals`\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>\> : `ZodTuple`\<`T`, `Rest`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodTuple`\<`T`, `Rest`\> & [`ZodType`](ZodType-1.md)\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\], `$ZodTypeInternals`\<`R`, \[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>\> : `ZodTuple`\<`T`, `Rest`\>
...
...`ZodTuple`\<`T`, `Rest`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodTuple`\<`T`, `Rest`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodTuple`\<`T`, `Rest`\>\>\] : \[`"Incompatible schema"`\]
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:522

#### Type Parameters

##### Rest

`Rest` *extends* [`SomeType`](../namespaces/core/type-aliases/SomeType.md) = [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`unknown`, `unknown`, `$ZodTypeInternals`\<`unknown`, `unknown`\>\>
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleInputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? input<Rest>[] : [])[]`\]\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<\[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodTuple`\<`T`, `Rest`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodTuple`\<`T`, `Rest`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodTuple`\<`T`, `Rest`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, \[`...TupleOutputTypeWithOptionals<T>[]`, `...(Rest extends SomeType ? output<Rest>[] : [])[]`\]\>\>
