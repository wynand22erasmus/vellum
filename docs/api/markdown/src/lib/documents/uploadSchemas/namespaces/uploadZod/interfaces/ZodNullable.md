...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:612

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodNullableInternals`](../namespaces/core/interfaces/$ZodNullableInternals.md)\<`T`\>\>.[`$ZodNullable`](../namespaces/core/interfaces/$ZodNullable.md)\<`T`\>
...
> **\_def**: [`$ZodNullableDef`](../namespaces/core/interfaces/$ZodNullableDef.md)\<`T`\>
...
> **\_input**: [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`
...
> **\_output**: [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`
...
> **\_zod**: [`$ZodNullableInternals`](../namespaces/core/interfaces/$ZodNullableInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodNullable`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:613
...
> **def**: [`$ZodNullableDef`](../namespaces/core/interfaces/$ZodNullableDef.md)\<`T`\>
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodNullable`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodNullable`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodNullable`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodNullable`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodNullable`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNullable`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodNullable`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNullable`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodNullable`\<`T`\>\>
...
[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`

##### Returns

[`ZodCatch`](ZodCatch.md)\<`ZodNullable`\<`T`\>\>
...
(`ctx`) => [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>)[]
...
[`$ZodNullableDef`](../namespaces/core/interfaces/$ZodNullableDef.md)\<`T`\>
...
> **decode**(`data`, `params?`): [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`
...
[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`
...
> **decodeAsync**(`data`, `params?`): `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>
...
`Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodNullable`\<`T`\>\>
...
[`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\> \| `null`

##### Returns

[`ZodDefault`](ZodDefault.md)\<`ZodNullable`\<`T`\>\>
...
> **encode**(`data`, `params?`): [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`
...
> **encodeAsync**(`data`, `params?`): `Promise`\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>
...
`Promise`\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodNullable`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodNullable`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodNullable`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodNullable`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<`ZodNullable`\<`ZodNullable`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodNullable`\<`ZodNullable`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodNullable`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodNullable`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodNullable`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodNullable`\<`T`\>, `T`\]\>
...
(`x`) => [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`
...
> **parse**(`data`, `params?`): [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`
...
> **parseAsync**(`data`, `params?`): `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodNullable`\<`T`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`, `$ZodTypeInternals`\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`, `$ZodTypeInternals`\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodNullable`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodNullable`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodNullable`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodNullable`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodNullable`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodNullable`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>\> : `ZodNullable`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodNullable`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>\> : `ZodNullable`\<`T`\>
...
...`ZodNullable`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNullable`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNullable`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `null`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNullable`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNullable`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodNullable`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodNullable`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\> \| `null`\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:614
