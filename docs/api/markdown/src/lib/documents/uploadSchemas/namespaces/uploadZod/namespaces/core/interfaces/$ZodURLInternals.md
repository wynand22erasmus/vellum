# Interface: $ZodURLInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:167

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"url"`\>

## Properties

### def

> **def**: [`$ZodURLDef`]($ZodURLDef.md)

Defined in: node\_modules/zod/v4/core/schemas.d.cts:168
