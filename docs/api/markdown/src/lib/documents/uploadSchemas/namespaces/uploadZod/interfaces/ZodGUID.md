...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:180

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"guid"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"guid"`\>
...
> **\_zod**: [`$ZodGUIDInternals`](../namespaces/core/interfaces/$ZodGUIDInternals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:181
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodGUID`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"guid"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodGUID`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodGUID`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodGUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodGUID`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodGUID` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodGUID`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodGUID` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodGUID`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodGUID`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"guid"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodGUID`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodGUID`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodGUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodGUID`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodGUID`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodGUID`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodGUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodGUID`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodGUID`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodGUID`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodGUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodGUID`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodGUID`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodGUID`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodGUID`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodGUID`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodGUID`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodGUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodGUID`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodGUID` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodGUID`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodGUID` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodGUID`
...
...`ZodGUID` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodGUID`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodGUID`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodGUID`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodGUID`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodGUID`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodGUID`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
