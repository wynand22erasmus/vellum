...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:433

## Extends

- [`_ZodDate`](ZodDate.md)\<[`$ZodDateInternals`](../namespaces/core/interfaces/$ZodDateInternals.md)\<`Date`\>\>
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodDate`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodDate`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodDate`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodDate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodDate`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodDate` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodDate`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodDate` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodDate`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodDate`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodDate`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodDate`\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`Date`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodDate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodDate`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodDate`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodDate`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodDate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodDate`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodDate`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodDate`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodDate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodDate`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodDate`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodDate`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodDate`, `T`\>
...
`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Date`, `$ZodTypeInternals`\<`any`, `Date`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodDate`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodDate`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodDate`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodDate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodDate`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodDate` & [`ZodType`](ZodType-1.md)\<`R`, `Date`, `$ZodTypeInternals`\<`R`, `Date`\>\> : `ZodDate`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodDate` & [`ZodType`](ZodType-1.md)\<`R`, `Date`, `$ZodTypeInternals`\<`R`, `Date`\>\> : `ZodDate`
...
...`ZodDate` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodDate`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodDate`\>\] : \[`"Incompatible schema"`\]
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Date`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Date`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodDate`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodDate`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodDate`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `Date`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodDate`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `Date`\>\>
