/**
 * Tooltip overlay primitives (Radix Tooltip).
 *
...
/** Provider configuring tooltip delay and behavior for descendants. */
...
/** Root tooltip state container for trigger and content. */
function Tooltip({
  ...props
...
/** Floating tooltip panel rendered in a portal. */
