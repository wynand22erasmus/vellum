/**
 * Alert banner primitives for status and error messaging.
 *
...
/** Root alert container with optional icon and action slots. */
function Alert({
  className,
  variant,
  ...props
...
/** Supporting alert body copy with muted styling. */
...
/** Optional action control positioned in the alert corner. */
