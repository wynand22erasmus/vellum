...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:677

## Extends

- [`ZodPipe`](ZodPipe.md)\<[`$ZodTransform`](../namespaces/core/interfaces/$ZodTransform.md), `B`\>.[`$ZodPreprocess`](../namespaces/core/interfaces/$ZodPreprocess.md)\<`B`\>
...
> **\_def**: [`$ZodPipeDef`](../namespaces/core/interfaces/$ZodPipeDef.md)\<[`$ZodTransform`](../namespaces/core/interfaces/$ZodTransform.md)\<`unknown`, `unknown`\>, `B`\>
...
> **\_zod**: [`$ZodPreprocessInternals`](../namespaces/core/interfaces/$ZodPreprocessInternals.md)\<`B`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:679
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodPreprocess`\<`B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:678
...
> **def**: [`$ZodPreprocessDef`](../namespaces/core/interfaces/$ZodPreprocessDef.md)\<`B`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:680
...
> **in**: [`$ZodTransform`](../namespaces/core/interfaces/$ZodTransform.md)
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodPreprocess`\<`B`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodPreprocess`\<`B`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodPreprocess`\<`B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodPreprocess`\<`B`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodPreprocess`\<`B`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodPreprocess`\<`B`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodPreprocess`\<`B`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodPreprocess`\<`B`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodPreprocess`\<`B`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodPreprocess`\<`B`\>\>
...
[`$ZodPipeDef`](../namespaces/core/interfaces/$ZodPipeDef.md)\<[`$ZodTransform`](../namespaces/core/interfaces/$ZodTransform.md)\<`unknown`, `unknown`\>, `B`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodPreprocess`\<`B`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodPreprocess`\<`B`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodPreprocess`\<`B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodPreprocess`\<`B`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodPreprocess`\<`B`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodPreprocess`\<`B`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodPreprocess`\<`B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodPreprocess`\<`B`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodPreprocess`\<`B`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodPreprocess`\<`B`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodPreprocess`\<`B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodPreprocess`\<`B`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodPreprocess`\<`B`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodPreprocess`\<`B`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodPreprocess`\<`B`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodPreprocess`\<`B`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodPreprocess`\<`B`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodPreprocess`\<`B`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodPreprocess`\<`B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodPreprocess`\<`B`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodPreprocess`\<`B`\> & [`ZodType`](ZodType-1.md)\<`R`, `unknown`, `$ZodTypeInternals`\<`R`, `unknown`\>\> : `ZodPreprocess`\<`B`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodPreprocess`\<`B`\> & [`ZodType`](ZodType-1.md)\<`R`, `unknown`, `$ZodTypeInternals`\<`R`, `unknown`\>\> : `ZodPreprocess`\<`B`\>
...
...`ZodPreprocess`\<`B`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodPreprocess`\<`B`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodPreprocess`\<`B`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodPreprocess`\<`B`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodPreprocess`\<`B`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodPreprocess`\<`B`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`B`\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodPreprocess`\<`B`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`B`\>\>\>
