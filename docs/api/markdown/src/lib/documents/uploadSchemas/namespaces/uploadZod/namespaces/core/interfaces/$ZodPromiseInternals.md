# Interface: $ZodPromiseInternals\<T\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:1137
...
> **def**: [`$ZodPromiseDef`]($ZodPromiseDef.md)\<`T`\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:1138
