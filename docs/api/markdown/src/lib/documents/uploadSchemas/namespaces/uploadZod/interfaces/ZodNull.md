...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:403

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodNullInternals`](../namespaces/core/interfaces/$ZodNullInternals.md)\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodNullDef`](../namespaces/core/interfaces/$ZodNullDef.md)
...
> **\_zod**: [`$ZodNullInternals`](../namespaces/core/interfaces/$ZodNullInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodNull`\>
...
> **def**: [`$ZodNullDef`](../namespaces/core/interfaces/$ZodNullDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodNull`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodNull`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodNull`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodNull`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodNull` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNull`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodNull` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNull`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodNull`\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`null`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`null`\>)[]
...
[`$ZodNullDef`](../namespaces/core/interfaces/$ZodNullDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`null`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodNull`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodNull`\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`null`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodNull`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodNull`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodNull`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodNull`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodNull`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodNull`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodNull`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodNull`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodNull`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodNull`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodNull`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodNull`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodNull`, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `null`, `$ZodTypeInternals`\<`any`, `null`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `null`, `$ZodTypeInternals`\<`any`, `null`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodNull`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodNull`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodNull`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodNull`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodNull`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodNull` & [`ZodType`](ZodType-1.md)\<`R`, `null`, `$ZodTypeInternals`\<`R`, `null`\>\> : `ZodNull`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodNull` & [`ZodType`](ZodType-1.md)\<`R`, `null`, `$ZodTypeInternals`\<`R`, `null`\>\> : `ZodNull`
...
...`ZodNull` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNull`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNull`\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`null`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNull`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNull`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodNull`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `null`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodNull`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `null`\>\>
