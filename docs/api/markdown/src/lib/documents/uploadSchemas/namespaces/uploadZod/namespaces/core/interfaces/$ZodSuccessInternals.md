# Interface: $ZodSuccessInternals\<T\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:956
...
> **def**: [`$ZodSuccessDef`]($ZodSuccessDef.md)\<`T`\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:957
