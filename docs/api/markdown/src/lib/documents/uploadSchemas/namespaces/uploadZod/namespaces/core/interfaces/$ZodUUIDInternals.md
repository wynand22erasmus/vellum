# Interface: $ZodUUIDInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:147

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"uuid"`\>

## Properties

### def

> **def**: [`$ZodUUIDDef`]($ZodUUIDDef.md)

Defined in: node\_modules/zod/v4/core/schemas.d.cts:148
