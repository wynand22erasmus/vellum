# Interface: $ZodE164Internals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:358

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"e164"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"e164"`\>
