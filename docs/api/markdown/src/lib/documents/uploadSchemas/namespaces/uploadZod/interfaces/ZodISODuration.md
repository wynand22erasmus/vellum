# Interface: ZodISODuration

Defined in: node\_modules/zod/v4/classic/iso.d.cts:18
...
> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`string`\>
...
> **\_zod**: [`$ZodISODurationInternals`](../namespaces/core/interfaces/$ZodISODurationInternals.md)

Defined in: node\_modules/zod/v4/classic/iso.d.cts:19
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodISODuration`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`string`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodISODuration`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodISODuration`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodISODuration`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodISODuration`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodISODuration` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodISODuration`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodISODuration` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodISODuration`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodISODuration`\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodISODuration`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`string`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodISODuration`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodISODuration`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodISODuration`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodISODuration`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodISODuration`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodISODuration`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodISODuration`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodISODuration`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodISODuration`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodISODuration`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodISODuration`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodISODuration`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodISODuration`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodISODuration`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodISODuration`, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodISODuration`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodISODuration`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodISODuration`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodISODuration`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodISODuration`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodISODuration` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodISODuration`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodISODuration` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodISODuration`
...
...`ZodISODuration` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodISODuration`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodISODuration`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodISODuration`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodISODuration`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodISODuration`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodISODuration`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
