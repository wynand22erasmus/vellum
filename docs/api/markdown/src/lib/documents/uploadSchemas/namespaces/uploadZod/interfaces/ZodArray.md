...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:437

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodArrayInternals`](../namespaces/core/interfaces/$ZodArrayInternals.md)\<`T`\>\>.[`$ZodArray`](../namespaces/core/interfaces/$ZodArray.md)\<`T`\>
...
> **\_def**: [`$ZodArrayDef`](../namespaces/core/interfaces/$ZodArrayDef.md)\<`T`\>
...
> **\_zod**: [`$ZodArrayInternals`](../namespaces/core/interfaces/$ZodArrayInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodArray`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:444
...
> **def**: [`$ZodArrayDef`](../namespaces/core/interfaces/$ZodArrayDef.md)\<`T`\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:438
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodArray`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodArray`\<`T`\>, `T`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodArray`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodArray`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodArray`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodArray`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodArray`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodArray`\<`T`\>\>
...
[`$ZodArrayDef`](../namespaces/core/interfaces/$ZodArrayDef.md)\<`T`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodArray`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodArray`\<`T`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodArray`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodArray`\<`T`\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:442
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:441
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:439
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:440
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodArray`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodArray`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodArray`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodArray`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodArray`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodArray`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodArray`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodArray`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodArray`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodArray`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodArray`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodArray`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodArray`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodArray`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodArray`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodArray`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodArray`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>[], `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>[]\>\> : `ZodArray`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodArray`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>[], `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>[]\>\> : `ZodArray`\<`T`\>
...
...`ZodArray`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodArray`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodArray`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodArray`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodArray`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodArray`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>[]\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodArray`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>[]\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:443
