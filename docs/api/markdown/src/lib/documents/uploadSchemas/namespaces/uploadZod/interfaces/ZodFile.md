...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:587

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodFileInternals`](../namespaces/core/interfaces/$ZodFileInternals.md)\>.[`$ZodFile`](../namespaces/core/interfaces/$ZodFile.md)

## Properties

### ~~\_def~~

> **\_def**: [`$ZodFileDef`](../namespaces/core/interfaces/$ZodFileDef.md)
...
> **\_input**: [`File`](../namespaces/core/interfaces/File.md)
...
> **\_output**: [`File`](../namespaces/core/interfaces/File.md)
...
> **\_zod**: [`$ZodFileInternals`](../namespaces/core/interfaces/$ZodFileInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodFile`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:588
...
> **def**: [`$ZodFileDef`](../namespaces/core/interfaces/$ZodFileDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodFile`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodFile`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodFile`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodFile`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodFile` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodFile`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodFile` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodFile`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodFile`\>
...
[`File`](../namespaces/core/interfaces/File.md)

##### Returns

[`ZodCatch`](ZodCatch.md)\<`ZodFile`\>
...
(`ctx`) => [`File`](../namespaces/core/interfaces/File.md)
...
...([`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<[`File`](../namespaces/core/interfaces/File.md)\> \| [`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<[`File`](../namespaces/core/interfaces/File.md)\>)[]
...
[`$ZodFileDef`](../namespaces/core/interfaces/$ZodFileDef.md)
...
> **decode**(`data`, `params?`): [`File`](../namespaces/core/interfaces/File.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<[`File`](../namespaces/core/interfaces/File.md)\>
...
`Promise`\<[`File`](../namespaces/core/interfaces/File.md)\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodFile`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodFile`\>
...
> **encode**(`data`, `params?`): [`File`](../namespaces/core/interfaces/File.md)
...
> **encodeAsync**(`data`, `params?`): `Promise`\<[`File`](../namespaces/core/interfaces/File.md)\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodFile`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodFile`\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:590
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:591

#### Parameters

##### types

[`MimeTypes`](../namespaces/util/type-aliases/MimeTypes.md) \| [`MimeTypes`](../namespaces/util/type-aliases/MimeTypes.md)[]

##### params?

`string` \| \{ `abort?`: `boolean`; `error?`: `string` \| [`$ZodErrorMap`](../namespaces/core/interfaces/$ZodErrorMap.md)\<[`$ZodIssueInvalidValue`](../namespaces/core/interfaces/$ZodIssueInvalidValue.md)\<`unknown`\>\>; `message?`: `string`; \}
...
\{ `abort?`: `boolean`; `error?`: `string` \| [`$ZodErrorMap`](../namespaces/core/interfaces/$ZodErrorMap.md)\<[`$ZodIssueInvalidValue`](../namespaces/core/interfaces/$ZodIssueInvalidValue.md)\<`unknown`\>\>; `message?`: `string`; \}
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:589
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodFile`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodFile`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodFile`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodFile`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodFile`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodFile`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodFile`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodFile`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodFile`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodFile`, `T`\]\>
...
(`x`) => [`File`](../namespaces/core/interfaces/File.md)
...
> **parse**(`data`, `params?`): [`File`](../namespaces/core/interfaces/File.md)
...
> **parseAsync**(`data`, `params?`): `Promise`\<[`File`](../namespaces/core/interfaces/File.md)\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodFile`, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`File`](../namespaces/core/interfaces/File.md), `$ZodTypeInternals`\<`any`, [`File`](../namespaces/core/interfaces/File.md)\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`File`](../namespaces/core/interfaces/File.md), `$ZodTypeInternals`\<`any`, [`File`](../namespaces/core/interfaces/File.md)\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodFile`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodFile`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodFile`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodFile`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodFile`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodFile` & [`ZodType`](ZodType-1.md)\<`R`, [`File`](../namespaces/core/interfaces/File.md), `$ZodTypeInternals`\<`R`, [`File`](../namespaces/core/interfaces/File.md)\>\> : `ZodFile`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodFile` & [`ZodType`](ZodType-1.md)\<`R`, [`File`](../namespaces/core/interfaces/File.md), `$ZodTypeInternals`\<`R`, [`File`](../namespaces/core/interfaces/File.md)\>\> : `ZodFile`
...
...`ZodFile` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodFile`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodFile`\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`File`](../namespaces/core/interfaces/File.md)\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodFile`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodFile`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodFile`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`File`](../namespaces/core/interfaces/File.md)\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodFile`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`File`](../namespaces/core/interfaces/File.md)\>\>
