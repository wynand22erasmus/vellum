...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:659

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodPipeInternals`](../namespaces/core/interfaces/$ZodPipeInternals.md)\<`A`, `B`\>\>.[`$ZodPipe`](../namespaces/core/interfaces/$ZodPipe.md)\<`A`, `B`\>

## Extended by

- [`ZodCodec`](ZodCodec.md)
- [`ZodPreprocess`](ZodPreprocess.md)
...
> **\_zod**: [`$ZodPipeInternals`](../namespaces/core/interfaces/$ZodPipeInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodPipe`\<`A`, `B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:660
...
> **def**: [`$ZodPipeDef`](../namespaces/core/interfaces/$ZodPipeDef.md)\<`A`, `B`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodPipe`\<`A`, `B`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodPipe`\<`A`, `B`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodPipe`\<`A`, `B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodPipe`\<`A`, `B`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodPipe`\<`A`, `B`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodPipe`\<`A`, `B`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodPipe`\<`A`, `B`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodPipe`\<`A`, `B`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodPipe`\<`A`, `B`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodPipe`\<`A`, `B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodPipe`\<`A`, `B`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodPipe`\<`A`, `B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodPipe`\<`A`, `B`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodPipe`\<`A`, `B`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodPipe`\<`A`, `B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodPipe`\<`A`, `B`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodPipe`\<`A`, `B`\>, `T`\]\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodPipe`\<`A`, `B`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodPipe`\<`A`, `B`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodPipe`\<`A`, `B`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`A`\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`A`\>\>\> : `ZodPipe`\<`A`, `B`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodPipe`\<`A`, `B`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`A`\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`A`\>\>\> : `ZodPipe`\<`A`, `B`\>
...
...`ZodPipe`\<`A`, `B`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodPipe`\<`A`, `B`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodPipe`\<`A`, `B`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodPipe`\<`A`, `B`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodPipe`\<`A`, `B`\>\>
...
> **transform**\<`NewOut`\>(`transform`): `ZodPipe`\<`ZodPipe`\<`A`, `B`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`B`\>\>\>
...
`ZodPipe`\<`ZodPipe`\<`A`, `B`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`B`\>\>\>
