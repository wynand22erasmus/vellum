# Interface: ZodISOTime

Defined in: node\_modules/zod/v4/classic/iso.d.cts:13
...
> **\_zod**: [`$ZodISOTimeInternals`](../namespaces/core/interfaces/$ZodISOTimeInternals.md)

Defined in: node\_modules/zod/v4/classic/iso.d.cts:14
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodISOTime`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodISOTime`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodISOTime`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodISOTime`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodISOTime`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodISOTime` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodISOTime`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodISOTime` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodISOTime`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodISOTime`\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodISOTime`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodISOTime`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodISOTime`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodISOTime`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodISOTime`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodISOTime`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodISOTime`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodISOTime`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodISOTime`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodISOTime`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodISOTime`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodISOTime`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodISOTime`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodISOTime`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodISOTime`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodISOTime`, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodISOTime`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodISOTime`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodISOTime`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodISOTime`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodISOTime`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodISOTime` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodISOTime`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodISOTime` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodISOTime`
...
...`ZodISOTime` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodISOTime`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodISOTime`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodISOTime`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodISOTime`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodISOTime`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodISOTime`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
