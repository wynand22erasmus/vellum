# Interface: $ZodCUID2Internals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:220

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"cuid2"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"cuid2"`\>
