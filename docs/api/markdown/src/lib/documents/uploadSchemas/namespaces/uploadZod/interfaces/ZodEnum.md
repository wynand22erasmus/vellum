...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:557

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodEnumInternals`](../namespaces/core/interfaces/$ZodEnumInternals.md)\<`T`\>\>.[`$ZodEnum`](../namespaces/core/interfaces/$ZodEnum.md)\<`T`\>

## Type Parameters

### T

`T` *extends* [`EnumLike`](../namespaces/util/type-aliases/EnumLike.md) = [`EnumLike`](../namespaces/util/type-aliases/EnumLike.md)

## Properties

### ~~\_def~~

> **\_def**: [`$ZodEnumDef`](../namespaces/core/interfaces/$ZodEnumDef.md)\<`T`\>
...
> **\_zod**: [`$ZodEnumInternals`](../namespaces/core/interfaces/$ZodEnumInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodEnum`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:560
...
> **def**: [`$ZodEnumDef`](../namespaces/core/interfaces/$ZodEnumDef.md)\<`T`\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:561
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:562

***

### spa

> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodEnum`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodEnum`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodEnum`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodEnum`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodEnum`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodEnum`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodEnum`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodEnum`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodEnum`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodEnum`\<`T`\>\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`T`\[keyof `T`\]\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`T`\[keyof `T`\]\>)[]
...
[`$ZodEnumDef`](../namespaces/core/interfaces/$ZodEnumDef.md)\<`T`\>
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`T`\[keyof `T`\]\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodEnum`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodEnum`\<`T`\>\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`T`\[keyof `T`\]\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodEnum`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodEnum`\<`T`\>\>
...
> **exclude**\<`U`\>(`values`, `params?`): `ZodEnum`\<\{ \[k in string \| number \| symbol\]: Omit\<T, U\[number\]\>\[k\] \}\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:564
...
`ZodEnum`\<\{ \[k in string \| number \| symbol\]: Omit\<T, U\[number\]\>\[k\] \}\>

***

### extract()

> **extract**\<`U`\>(`values`, `params?`): `ZodEnum`\<\{ \[k in string \| number \| symbol\]: Pick\<T, U\[number\]\>\[k\] \}\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:563
...
`ZodEnum`\<\{ \[k in string \| number \| symbol\]: Pick\<T, U\[number\]\>\[k\] \}\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodEnum`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodEnum`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodEnum`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodEnum`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodEnum`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodEnum`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodEnum`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodEnum`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodEnum`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodEnum`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodEnum`\<`T`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `T`\[keyof `T`\], `$ZodTypeInternals`\<`any`, `T`\[keyof `T`\]\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `T`\[keyof `T`\], `$ZodTypeInternals`\<`any`, `T`\[keyof `T`\]\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodEnum`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodEnum`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodEnum`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodEnum`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodEnum`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodEnum`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`\[keyof `T`\], `$ZodTypeInternals`\<`R`, `T`\[keyof `T`\]\>\> : `ZodEnum`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodEnum`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`\[keyof `T`\], `$ZodTypeInternals`\<`R`, `T`\[keyof `T`\]\>\> : `ZodEnum`\<`T`\>
...
...`ZodEnum`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodEnum`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodEnum`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`T`\[keyof `T`\]\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodEnum`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodEnum`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodEnum`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `T`\[keyof `T`\]\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodEnum`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `T`\[keyof `T`\]\>\>
