...
> **\_lte**(`value`, `params?`): [`$ZodCheckLessThan`](../interfaces/$ZodCheckLessThan.md)\<[`Numeric`](../../util/type-aliases/Numeric.md)\>
...
[`$ZodCheckLessThan`](../interfaces/$ZodCheckLessThan.md)\<[`Numeric`](../../util/type-aliases/Numeric.md)\>
