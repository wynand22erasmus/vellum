...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:493

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodUnionInternals`](../namespaces/core/interfaces/$ZodUnionInternals.md)\<`T`\>\>.[`$ZodUnion`](../namespaces/core/interfaces/$ZodUnion.md)\<`T`\>
...
> **\_zod**: [`$ZodUnionInternals`](../namespaces/core/interfaces/$ZodUnionInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodUnion`\<`T`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodUnion`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodUnion`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodUnion`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodUnion`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodUnion`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodUnion`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodUnion`\<`T`\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodUnion`\<`T`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodUnion`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodUnion`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodUnion`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodUnion`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodUnion`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodUnion`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodUnion`\<`T`\>\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodUnion`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodUnion`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodUnion`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodUnion`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodUnion`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodUnion`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>, `$ZodTypeInternals`\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>\>\> : `ZodUnion`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodUnion`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>, `$ZodTypeInternals`\<`R`, [`$InferUnionInput`](../namespaces/core/type-aliases/$InferUnionInput.md)\<`T`\[`number`\]\>\>\> : `ZodUnion`\<`T`\>
...
...`ZodUnion`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodUnion`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodUnion`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodUnion`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodUnion`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodUnion`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`$InferUnionOutput`](../namespaces/core/type-aliases/$InferUnionOutput.md)\<`T`\[`number`\]\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodUnion`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`$InferUnionOutput`](../namespaces/core/type-aliases/$InferUnionOutput.md)\<`T`\[`number`\]\>\>\>
