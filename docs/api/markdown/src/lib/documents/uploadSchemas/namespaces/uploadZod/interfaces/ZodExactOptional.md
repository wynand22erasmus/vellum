# Interface: ZodExactOptional\<T\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:606

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodExactOptionalInternals`](../namespaces/core/interfaces/$ZodExactOptionalInternals.md)\<`T`\>\>.[`$ZodExactOptional`](../namespaces/core/interfaces/$ZodExactOptional.md)\<`T`\>
...
> **\_def**: [`$ZodExactOptionalDef`](../namespaces/core/interfaces/$ZodExactOptionalDef.md)\<`T`\>
...
> **\_zod**: [`$ZodExactOptionalInternals`](../namespaces/core/interfaces/$ZodExactOptionalInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodExactOptional`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:607
...
> **def**: [`$ZodExactOptionalDef`](../namespaces/core/interfaces/$ZodExactOptionalDef.md)\<`T`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodExactOptional`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodExactOptional`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodExactOptional`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodExactOptional`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodExactOptional`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodExactOptional`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodExactOptional`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodExactOptional`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodExactOptional`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodExactOptional`\<`T`\>\>
...
[`$ZodExactOptionalDef`](../namespaces/core/interfaces/$ZodExactOptionalDef.md)\<`T`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodExactOptional`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodExactOptional`\<`T`\>\>
...
> **exactOptional**(): `ZodExactOptional`\<`ZodExactOptional`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

`ZodExactOptional`\<`ZodExactOptional`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodExactOptional`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodExactOptional`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodExactOptional`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodExactOptional`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodExactOptional`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodExactOptional`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodExactOptional`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodExactOptional`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodExactOptional`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodExactOptional`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodExactOptional`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodExactOptional`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodExactOptional`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodExactOptional`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodExactOptional`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodExactOptional`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodExactOptional`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>\> : `ZodExactOptional`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodExactOptional`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>\> : `ZodExactOptional`\<`T`\>
...
...`ZodExactOptional`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodExactOptional`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodExactOptional`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodExactOptional`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodExactOptional`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodExactOptional`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodExactOptional`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:608
