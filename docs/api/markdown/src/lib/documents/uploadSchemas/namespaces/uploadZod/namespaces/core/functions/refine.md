...
> **\_refine**\<`O`, `I`\>(`Class`, `fn`, `_params`): [`$ZodCustom`](../interfaces/$ZodCustom.md)\<`O`, `I`\>

Defined in: node\_modules/zod/v4/core/api.d.cts:291
...
`string` \| \{ `abort?`: `boolean`; `error?`: `string` \| [`$ZodErrorMap`](../interfaces/$ZodErrorMap.md)\<`NonNullable`\<[`$ZodIssue`](../type-aliases/$ZodIssue.md)\>\>; `message?`: `string`; `params?`: `Record`\<`string`, `any`\>; `path?`: `PropertyKey`[]; `when?`: (`payload`) => `boolean`; \} \| `undefined`
