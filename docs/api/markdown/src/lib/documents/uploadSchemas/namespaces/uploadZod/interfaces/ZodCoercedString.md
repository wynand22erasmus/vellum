# Interface: ZodCoercedString\<T\>

Defined in: node\_modules/zod/v4/classic/coerce.d.cts:3

## Extends

- [`_ZodString`](ZodString.md)\<[`$ZodStringInternals`](../namespaces/core/interfaces/$ZodStringInternals.md)\<`T`\>\>
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCoercedString`\<`T`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCoercedString`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCoercedString`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCoercedString`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCoercedString`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCoercedString`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCoercedString`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCoercedString`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCoercedString`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodCoercedString`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodCoercedString`\<`T`\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCoercedString`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCoercedString`\<`T`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCoercedString`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCoercedString`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCoercedString`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCoercedString`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCoercedString`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCoercedString`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCoercedString`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCoercedString`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCoercedString`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCoercedString`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCoercedString`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCoercedString`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCoercedString`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCoercedString`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCoercedString`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCoercedString`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCoercedString`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCoercedString`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedString`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, `$ZodTypeInternals`\<`R`, `T`\>\> : `ZodCoercedString`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedString`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, `$ZodTypeInternals`\<`R`, `T`\>\> : `ZodCoercedString`\<`T`\>
...
...`ZodCoercedString`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCoercedString`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCoercedString`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCoercedString`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCoercedString`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCoercedString`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCoercedString`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
