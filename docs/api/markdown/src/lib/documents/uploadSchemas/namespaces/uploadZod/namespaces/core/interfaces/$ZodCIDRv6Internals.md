# Interface: $ZodCIDRv6Internals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:331

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"cidrv6"`\>

## Properties

### def

> **def**: [`$ZodCIDRv6Def`]($ZodCIDRv6Def.md)
