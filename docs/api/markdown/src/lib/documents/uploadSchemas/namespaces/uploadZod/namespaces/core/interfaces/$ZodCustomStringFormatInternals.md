# Interface: $ZodCustomStringFormatInternals\<Format\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:378

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`Format`\>
...
> **def**: [`$ZodCustomStringFormatDef`]($ZodCustomStringFormatDef.md)\<`Format`\>
