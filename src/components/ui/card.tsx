...
/** Bordered card container with optional compact `size`. */
function Card({
  className,
  size = "default",
  ...props
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card relative flex flex-col gap-6 overflow-hidden rounded-4xl border border-border/60 bg-card/95 py-6 text-sm text-card-foreground shadow-md shadow-primary/8 ring-1 ring-primary/10 backdrop-blur-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-4xl *:[img:last-child]:rounded-b-4xl",
        className
      )}
      {...props}
    />
...
/** Optional action slot aligned to the card header corner. */
...
/** Bottom section for card actions or metadata. */
