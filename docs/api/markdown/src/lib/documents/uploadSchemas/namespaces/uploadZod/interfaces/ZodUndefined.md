...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:398

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodUndefinedInternals`](../namespaces/core/interfaces/$ZodUndefinedInternals.md)\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodUndefinedDef`](../namespaces/core/interfaces/$ZodUndefinedDef.md)
...
> **\_zod**: [`$ZodUndefinedInternals`](../namespaces/core/interfaces/$ZodUndefinedInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodUndefined`\>
...
> **def**: [`$ZodUndefinedDef`](../namespaces/core/interfaces/$ZodUndefinedDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodUndefined`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodUndefined`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodUndefined`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodUndefined`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodUndefined` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodUndefined`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodUndefined` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodUndefined`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodUndefined`\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodUndefined`\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`undefined`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`undefined`\>)[]
...
[`$ZodUndefinedDef`](../namespaces/core/interfaces/$ZodUndefinedDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`undefined`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodUndefined`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodUndefined`\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`undefined`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodUndefined`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodUndefined`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodUndefined`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodUndefined`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodUndefined`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodUndefined`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodUndefined`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodUndefined`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodUndefined`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodUndefined`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodUndefined`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodUndefined`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodUndefined`, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `undefined`, `$ZodTypeInternals`\<`any`, `undefined`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `undefined`, `$ZodTypeInternals`\<`any`, `undefined`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodUndefined`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodUndefined`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodUndefined`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodUndefined`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodUndefined`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodUndefined` & [`ZodType`](ZodType-1.md)\<`R`, `undefined`, `$ZodTypeInternals`\<`R`, `undefined`\>\> : `ZodUndefined`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodUndefined` & [`ZodType`](ZodType-1.md)\<`R`, `undefined`, `$ZodTypeInternals`\<`R`, `undefined`\>\> : `ZodUndefined`
...
...`ZodUndefined` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodUndefined`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodUndefined`\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`undefined`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodUndefined`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodUndefined`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodUndefined`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `undefined`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodUndefined`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `undefined`\>\>
