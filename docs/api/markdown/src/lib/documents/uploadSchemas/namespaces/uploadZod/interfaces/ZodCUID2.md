...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:231

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"cuid2"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"cuid2"`\>
...
> **\_zod**: [`$ZodCUID2Internals`](../namespaces/core/interfaces/$ZodCUID2Internals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:232
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCUID2`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"cuid2"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCUID2`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCUID2`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCUID2`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCUID2`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCUID2` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCUID2`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCUID2` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCUID2`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodCUID2`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"cuid2"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCUID2`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCUID2`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCUID2`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCUID2`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCUID2`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCUID2`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCUID2`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCUID2`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCUID2`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCUID2`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCUID2`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCUID2`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCUID2`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCUID2`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCUID2`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCUID2`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCUID2`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCUID2`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCUID2`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCUID2` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodCUID2`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCUID2` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodCUID2`
...
...`ZodCUID2` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCUID2`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCUID2`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCUID2`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCUID2`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCUID2`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCUID2`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
