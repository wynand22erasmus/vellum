...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:416

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodNeverInternals`](../namespaces/core/interfaces/$ZodNeverInternals.md)\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodNeverDef`](../namespaces/core/interfaces/$ZodNeverDef.md)
...
> **\_zod**: [`$ZodNeverInternals`](../namespaces/core/interfaces/$ZodNeverInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodNever`\>
...
> **def**: [`$ZodNeverDef`](../namespaces/core/interfaces/$ZodNeverDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodNever`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodNever`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodNever` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNever`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodNever` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNever`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodNever`\>
...
...([`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`never`\> \| [`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`never`\>)[]
...
[`$ZodNeverDef`](../namespaces/core/interfaces/$ZodNeverDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`never`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodNever`\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`never`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodNever`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodNever`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodNever`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodNever`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodNever`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodNever`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodNever`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodNever`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodNever`, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `never`, `$ZodTypeInternals`\<`any`, `never`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `never`, `$ZodTypeInternals`\<`any`, `never`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodNever`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodNever`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodNever`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodNever`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodNever` & [`ZodType`](ZodType-1.md)\<`R`, `never`, `$ZodTypeInternals`\<`R`, `never`\>\> : `ZodNever`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodNever` & [`ZodType`](ZodType-1.md)\<`R`, `never`, `$ZodTypeInternals`\<`R`, `never`\>\> : `ZodNever`
...
...`ZodNever` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNever`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNever`\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`never`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNever`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNever`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodNever`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `never`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodNever`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `never`\>\>
