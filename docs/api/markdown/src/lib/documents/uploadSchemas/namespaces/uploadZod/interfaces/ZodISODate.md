...
Defined in: node\_modules/zod/v4/classic/iso.d.cts:8
...
> **\_zod**: [`$ZodISODateInternals`](../namespaces/core/interfaces/$ZodISODateInternals.md)

Defined in: node\_modules/zod/v4/classic/iso.d.cts:9
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodISODate`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodISODate`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodISODate`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodISODate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodISODate`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodISODate` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodISODate`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodISODate` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodISODate`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodISODate`\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodISODate`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodISODate`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodISODate`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodISODate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodISODate`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodISODate`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodISODate`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodISODate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodISODate`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodISODate`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodISODate`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodISODate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodISODate`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodISODate`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodISODate`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodISODate`, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodISODate`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodISODate`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodISODate`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodISODate`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodISODate`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodISODate` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodISODate`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodISODate` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodISODate`
...
...`ZodISODate` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodISODate`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodISODate`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodISODate`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodISODate`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodISODate`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodISODate`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
