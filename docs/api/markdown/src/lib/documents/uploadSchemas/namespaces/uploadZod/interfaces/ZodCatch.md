...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:645

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodCatchInternals`](../namespaces/core/interfaces/$ZodCatchInternals.md)\<`T`\>\>.[`$ZodCatch`](../namespaces/core/interfaces/$ZodCatch.md)\<`T`\>
...
> **\_def**: [`$ZodCatchDef`](../namespaces/core/interfaces/$ZodCatchDef.md)\<`T`\>
...
> **\_zod**: [`$ZodCatchInternals`](../namespaces/core/interfaces/$ZodCatchInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCatch`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:646
...
> **def**: [`$ZodCatchDef`](../namespaces/core/interfaces/$ZodCatchDef.md)\<`T`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCatch`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCatch`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCatch`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCatch`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCatch`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCatch`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCatch`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCatch`\<`T`\>, `T`, `Dir`\>
...
[`$ZodCatchDef`](../namespaces/core/interfaces/$ZodCatchDef.md)\<`T`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCatch`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCatch`\<`T`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCatch`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCatch`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCatch`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCatch`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCatch`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCatch`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCatch`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCatch`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCatch`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCatch`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCatch`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCatch`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCatch`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCatch`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCatch`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCatch`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCatch`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCatch`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCatch`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>\> : `ZodCatch`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCatch`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>\> : `ZodCatch`\<`T`\>
...
...`ZodCatch`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCatch`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCatch`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:649
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCatch`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCatch`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCatch`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCatch`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:647
