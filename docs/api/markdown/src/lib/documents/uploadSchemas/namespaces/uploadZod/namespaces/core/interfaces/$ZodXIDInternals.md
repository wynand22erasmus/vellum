# Interface: $ZodXIDInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:236

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"xid"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"xid"`\>
