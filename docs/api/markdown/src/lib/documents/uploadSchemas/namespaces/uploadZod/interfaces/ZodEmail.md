...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:175

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"email"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"email"`\>
...
> **\_zod**: [`$ZodEmailInternals`](../namespaces/core/interfaces/$ZodEmailInternals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:176
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodEmail`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"email"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodEmail`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodEmail`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodEmail`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodEmail`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodEmail` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodEmail`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodEmail` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodEmail`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodEmail`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"email"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodEmail`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodEmail`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodEmail`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodEmail`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodEmail`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodEmail`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodEmail`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodEmail`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodEmail`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodEmail`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodEmail`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodEmail`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodEmail`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodEmail`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodEmail`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodEmail`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodEmail`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodEmail`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodEmail`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodEmail` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodEmail`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodEmail` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodEmail`
...
...`ZodEmail` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodEmail`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodEmail`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodEmail`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodEmail`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodEmail`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodEmail`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
