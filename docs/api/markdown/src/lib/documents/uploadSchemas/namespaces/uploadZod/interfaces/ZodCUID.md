...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:214
...
- [`ZodStringFormat`](ZodStringFormat.md)\<`"cuid"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"cuid"`\>
...
> **\_zod**: [`$ZodCUIDInternals`](../namespaces/core/interfaces/$ZodCUIDInternals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:215
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCUID`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"cuid"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCUID`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCUID`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCUID`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCUID` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCUID`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCUID` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCUID`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodCUID`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"cuid"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCUID`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCUID`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCUID`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCUID`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCUID`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCUID`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCUID`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCUID`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCUID`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCUID`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCUID`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCUID`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCUID`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCUID`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCUID`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCUID` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodCUID`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCUID` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodCUID`
...
...`ZodCUID` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCUID`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCUID`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCUID`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCUID`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCUID`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCUID`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
