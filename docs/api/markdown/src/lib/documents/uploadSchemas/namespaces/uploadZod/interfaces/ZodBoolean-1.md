...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:362

## Extends

- [`_ZodBoolean`](ZodBoolean.md)\<[`$ZodBooleanInternals`](../namespaces/core/interfaces/$ZodBooleanInternals.md)\<`boolean`\>\>
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodBoolean`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodBoolean`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodBoolean`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodBoolean` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodBoolean`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodBoolean` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodBoolean`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodBoolean`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodBoolean`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodBoolean`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodBoolean`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodBoolean`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodBoolean`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodBoolean`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodBoolean`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodBoolean`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodBoolean`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodBoolean`, `T`\>
...
`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `boolean`, `$ZodTypeInternals`\<`any`, `boolean`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodBoolean`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodBoolean`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodBoolean`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodBoolean`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodBoolean` & [`ZodType`](ZodType-1.md)\<`R`, `boolean`, `$ZodTypeInternals`\<`R`, `boolean`\>\> : `ZodBoolean`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodBoolean` & [`ZodType`](ZodType-1.md)\<`R`, `boolean`, `$ZodTypeInternals`\<`R`, `boolean`\>\> : `ZodBoolean`
...
...`ZodBoolean` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodBoolean`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodBoolean`\>\] : \[`"Incompatible schema"`\]
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`boolean`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`boolean`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodBoolean`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodBoolean`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodBoolean`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `boolean`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodBoolean`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `boolean`\>\>
