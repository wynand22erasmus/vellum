# Interface: $ZodISODateInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:264

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"date"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"date"`\>
