# Interface: $ZodMapInternals\<Key, Value\>

Defined in: node\_modules/zod/v4/core/schemas.d.cts:766

## Type Parameters

### Key

`Key` *extends* [`SomeType`](../type-aliases/SomeType.md) = [`$ZodType`]($ZodType-1.md)
...
> **def**: [`$ZodMapDef`]($ZodMapDef.md)\<`Key`, `Value`\>
