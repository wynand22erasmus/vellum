...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:199

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"emoji"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"emoji"`\>
...
> **\_zod**: [`$ZodEmojiInternals`](../namespaces/core/interfaces/$ZodEmojiInternals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:200
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodEmoji`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"emoji"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodEmoji`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodEmoji`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodEmoji`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodEmoji`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodEmoji` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodEmoji`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodEmoji` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodEmoji`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodEmoji`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"emoji"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodEmoji`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodEmoji`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodEmoji`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodEmoji`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodEmoji`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodEmoji`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodEmoji`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodEmoji`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodEmoji`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodEmoji`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodEmoji`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodEmoji`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodEmoji`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodEmoji`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodEmoji`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodEmoji`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodEmoji`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodEmoji`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodEmoji`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodEmoji` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodEmoji`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodEmoji` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodEmoji`
...
...`ZodEmoji` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodEmoji`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodEmoji`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodEmoji`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodEmoji`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodEmoji`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodEmoji`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
