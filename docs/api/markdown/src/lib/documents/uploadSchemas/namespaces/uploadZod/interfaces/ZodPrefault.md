# Interface: ZodPrefault\<T\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:627

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodPrefaultInternals`](../namespaces/core/interfaces/$ZodPrefaultInternals.md)\<`T`\>\>.[`$ZodPrefault`](../namespaces/core/interfaces/$ZodPrefault.md)\<`T`\>
...
> **\_def**: [`$ZodPrefaultDef`](../namespaces/core/interfaces/$ZodPrefaultDef.md)\<`T`\>
...
> **\_zod**: [`$ZodPrefaultInternals`](../namespaces/core/interfaces/$ZodPrefaultInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodPrefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:628
...
> **def**: [`$ZodPrefaultDef`](../namespaces/core/interfaces/$ZodPrefaultDef.md)\<`T`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodPrefault`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodPrefault`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodPrefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodPrefault`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodPrefault`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodPrefault`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodPrefault`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodPrefault`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodPrefault`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodPrefault`\<`T`\>\>
...
[`$ZodPrefaultDef`](../namespaces/core/interfaces/$ZodPrefaultDef.md)\<`T`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodPrefault`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodPrefault`\<`T`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodPrefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodPrefault`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodPrefault`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodPrefault`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodPrefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodPrefault`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodPrefault`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodPrefault`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodPrefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodPrefault`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodPrefault`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodPrefault`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodPrefault`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodPrefault`\<`T`\>, `T`\>
...
> **prefault**(`def`): `ZodPrefault`\<`ZodPrefault`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodPrefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodPrefault`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodPrefault`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`\>\> : `ZodPrefault`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodPrefault`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`\>\> : `ZodPrefault`\<`T`\>
...
...`ZodPrefault`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodPrefault`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodPrefault`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodPrefault`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodPrefault`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodPrefault`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodPrefault`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:629
