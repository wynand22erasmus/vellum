# Interface: ZodCoercedBigInt\<T\>

Defined in: node\_modules/zod/v4/classic/coerce.d.cts:12

## Extends

- [`_ZodBigInt`](ZodBigInt.md)\<[`$ZodBigIntInternals`](../namespaces/core/interfaces/$ZodBigIntInternals.md)\<`T`\>\>
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCoercedBigInt`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCoercedBigInt`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCoercedBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCoercedBigInt`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCoercedBigInt`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCoercedBigInt`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCoercedBigInt`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCoercedBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCoercedBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCoercedBigInt`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCoercedBigInt`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCoercedBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCoercedBigInt`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCoercedBigInt`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCoercedBigInt`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCoercedBigInt`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCoercedBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedBigInt`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, `$ZodTypeInternals`\<`R`, `T`\>\> : `ZodCoercedBigInt`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCoercedBigInt`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, `T`, `$ZodTypeInternals`\<`R`, `T`\>\> : `ZodCoercedBigInt`\<`T`\>
...
...`ZodCoercedBigInt`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCoercedBigInt`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCoercedBigInt`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCoercedBigInt`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCoercedBigInt`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `bigint`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCoercedBigInt`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `bigint`\>\>
