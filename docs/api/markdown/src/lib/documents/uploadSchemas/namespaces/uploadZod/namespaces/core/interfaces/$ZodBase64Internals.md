# Interface: $ZodBase64Internals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:341

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"base64"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"base64"`\>
