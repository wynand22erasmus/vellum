...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:619

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodDefaultInternals`](../namespaces/core/interfaces/$ZodDefaultInternals.md)\<`T`\>\>.[`$ZodDefault`](../namespaces/core/interfaces/$ZodDefault.md)\<`T`\>
...
> **\_def**: [`$ZodDefaultDef`](../namespaces/core/interfaces/$ZodDefaultDef.md)\<`T`\>
...
> **\_zod**: [`$ZodDefaultInternals`](../namespaces/core/interfaces/$ZodDefaultInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodDefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:620
...
> **def**: [`$ZodDefaultDef`](../namespaces/core/interfaces/$ZodDefaultDef.md)\<`T`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodDefault`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodDefault`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodDefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodDefault`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodDefault`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodDefault`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodDefault`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodDefault`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodDefault`\<`T`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodDefault`\<`T`\>\>
...
[`$ZodDefaultDef`](../namespaces/core/interfaces/$ZodDefaultDef.md)\<`T`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodDefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodDefault`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodDefault`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodDefault`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodDefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodDefault`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodDefault`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodDefault`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodDefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodDefault`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodDefault`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodDefault`\<`T`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodDefault`\<`T`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodDefault`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodDefault`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodDefault`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodDefault`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodDefault`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodDefault`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`\>\> : `ZodDefault`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodDefault`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`T`\> \| `undefined`\>\> : `ZodDefault`\<`T`\>
...
...`ZodDefault`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodDefault`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodDefault`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:623
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodDefault`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodDefault`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodDefault`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodDefault`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>\>
...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:621
