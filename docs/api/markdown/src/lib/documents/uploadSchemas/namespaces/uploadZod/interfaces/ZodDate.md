...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:425
...
- [`ZodDate`](ZodDate-1.md)
- [`ZodCoercedDate`](ZodCoercedDate.md)

## Type Parameters

### T

`T` *extends* [`$ZodDateInternals`](../namespaces/core/interfaces/$ZodDateInternals.md) = [`$ZodDateInternals`](../namespaces/core/interfaces/$ZodDateInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`_ZodDate`\<`T`\>\>
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`_ZodDate`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`_ZodDate`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`_ZodDate`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`_ZodDate`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `_ZodDate`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`_ZodDate`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `_ZodDate`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`_ZodDate`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`_ZodDate`\<`T`\>\>
...
[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>

##### Returns

[`ZodCatch`](ZodCatch.md)\<`_ZodDate`\<`T`\>\>
...
(`ctx`) => [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>)[]
...
> **decode**(`data`, `params?`): [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>
...
[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>
...
> **decodeAsync**(`data`, `params?`): `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>
...
`Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`_ZodDate`\<`T`\>\>
...
[`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>

##### Returns

[`ZodDefault`](ZodDefault.md)\<`_ZodDate`\<`T`\>\>
...
> **encode**(`data`, `params?`): [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>
...
`Promise`\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`_ZodDate`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`_ZodDate`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`_ZodDate`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`_ZodDate`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`_ZodDate`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`_ZodDate`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`_ZodDate`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`_ZodDate`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`_ZodDate`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`_ZodDate`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`_ZodDate`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`_ZodDate`\<`T`\>, `T`\]\>
...
(`x`) => [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>
...
> **parse**(`data`, `params?`): [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>
...
> **parseAsync**(`data`, `params?`): `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`_ZodDate`\<`T`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>, `$ZodTypeInternals`\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>, `$ZodTypeInternals`\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`_ZodDate`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`_ZodDate`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`_ZodDate`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`_ZodDate`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`_ZodDate`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `_ZodDate`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>\> : `_ZodDate`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `_ZodDate`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>\> : `_ZodDate`\<`T`\>
...
...`_ZodDate`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `_ZodDate`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `_ZodDate`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodDate`\<`T`\>\>\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`_ZodDate`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`_ZodDate`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`_ZodDate`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`_ZodDate`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodDate`\<`T`\>\>\>\>
