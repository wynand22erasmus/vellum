# Interface: $ZodIPv6Internals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:301

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"ipv6"`\>

## Properties

### def

> **def**: [`$ZodIPv6Def`]($ZodIPv6Def.md)
