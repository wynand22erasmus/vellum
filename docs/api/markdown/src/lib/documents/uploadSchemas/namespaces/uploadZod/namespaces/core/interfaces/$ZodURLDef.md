...
- [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"url"`\>
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:163
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:164
