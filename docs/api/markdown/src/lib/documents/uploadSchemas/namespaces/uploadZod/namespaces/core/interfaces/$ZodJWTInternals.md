# Interface: $ZodJWTInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:368

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"jwt"`\>

## Properties

### def

> **def**: [`$ZodJWTDef`]($ZodJWTDef.md)
