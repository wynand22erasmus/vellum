# Interface: ZodTransform\<O, I\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:595

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodTransformInternals`](../namespaces/core/interfaces/$ZodTransformInternals.md)\<`O`, `I`\>\>.[`$ZodTransform`](../namespaces/core/interfaces/$ZodTransform.md)\<`O`, `I`\>
...
> **\_def**: [`$ZodTransformDef`](../namespaces/core/interfaces/$ZodTransformDef.md)
...
> **\_zod**: [`$ZodTransformInternals`](../namespaces/core/interfaces/$ZodTransformInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodTransform`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:596
...
> **def**: [`$ZodTransformDef`](../namespaces/core/interfaces/$ZodTransformDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodTransform`\<`O`, `I`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodTransform`\<`O`, `I`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodTransform`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodTransform`\<`O`, `I`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodTransform`\<`O`, `I`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodTransform`\<`O`, `I`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodTransform`\<`O`, `I`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodTransform`\<`O`, `I`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodTransform`\<`O`, `I`\>\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`O`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`O`\>)[]
...
[`$ZodTransformDef`](../namespaces/core/interfaces/$ZodTransformDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`O`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodTransform`\<`O`, `I`\>\>
...
[`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<`O`\>

##### Returns

[`ZodDefault`](ZodDefault.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`I`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodTransform`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodTransform`\<`O`, `I`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodTransform`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodTransform`\<`O`, `I`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodTransform`\<`O`, `I`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodTransform`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodTransform`\<`O`, `I`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodTransform`\<`O`, `I`\>, `T`\]\>
...
> **parseAsync**(`data`, `params?`): `Promise`\<`O`\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodTransform`\<`O`, `I`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `O`, `$ZodTypeInternals`\<`any`, `O`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `O`, `$ZodTypeInternals`\<`any`, `O`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodTransform`\<`O`, `I`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodTransform`\<`O`, `I`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodTransform`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodTransform`\<`O`, `I`\> & [`ZodType`](ZodType-1.md)\<`R`, `I`, `$ZodTypeInternals`\<`R`, `I`\>\> : `ZodTransform`\<`O`, `I`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodTransform`\<`O`, `I`\> & [`ZodType`](ZodType-1.md)\<`R`, `I`, `$ZodTypeInternals`\<`R`, `I`\>\> : `ZodTransform`\<`O`, `I`\>
...
...`ZodTransform`\<`O`, `I`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodTransform`\<`O`, `I`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodTransform`\<`O`, `I`\>\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`I`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`I`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`I`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`I`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`O`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodTransform`\<`O`, `I`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodTransform`\<`O`, `I`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodTransform`\<`O`, `I`\>, `ZodTransform`\<`Awaited`\<`NewOut`\>, `O`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodTransform`\<`O`, `I`\>, `ZodTransform`\<`Awaited`\<`NewOut`\>, `O`\>\>
