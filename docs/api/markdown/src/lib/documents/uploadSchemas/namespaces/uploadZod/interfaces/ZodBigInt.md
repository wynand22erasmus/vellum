...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:366
...
- [`ZodCoercedBigInt`](ZodCoercedBigInt.md)

## Type Parameters

### T

`T` *extends* [`$ZodBigIntInternals`](../namespaces/core/interfaces/$ZodBigIntInternals.md) = [`$ZodBigIntInternals`](../namespaces/core/interfaces/$ZodBigIntInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`_ZodBigInt`\<`T`\>\>
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`_ZodBigInt`\<`T`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`_ZodBigInt`\<`T`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`_ZodBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`_ZodBigInt`\<`T`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `_ZodBigInt`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`_ZodBigInt`\<`T`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `_ZodBigInt`\<`T`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`_ZodBigInt`\<`T`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`_ZodBigInt`\<`T`\>\>
...
[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>

##### Returns

[`ZodCatch`](ZodCatch.md)\<`_ZodBigInt`\<`T`\>\>
...
(`ctx`) => [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>)[]
...
> **decode**(`data`, `params?`): [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>
...
[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>
...
> **decodeAsync**(`data`, `params?`): `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>
...
`Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`_ZodBigInt`\<`T`\>\>
...
[`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>

##### Returns

[`ZodDefault`](ZodDefault.md)\<`_ZodBigInt`\<`T`\>\>
...
> **encode**(`data`, `params?`): [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>
...
`Promise`\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`_ZodBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`_ZodBigInt`\<`T`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`_ZodBigInt`\<`T`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`_ZodBigInt`\<`T`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`_ZodBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`_ZodBigInt`\<`T`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`_ZodBigInt`\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`_ZodBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`_ZodBigInt`\<`T`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`_ZodBigInt`\<`T`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`_ZodBigInt`\<`T`\>, `T`\]\>
...
(`x`) => [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>
...
> **parse**(`data`, `params?`): [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>
...
> **parseAsync**(`data`, `params?`): `Promise`\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`_ZodBigInt`\<`T`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>, `$ZodTypeInternals`\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>, `$ZodTypeInternals`\<`any`, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`_ZodBigInt`\<`T`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`_ZodBigInt`\<`T`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`_ZodBigInt`\<`T`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`_ZodBigInt`\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`_ZodBigInt`\<`T`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `_ZodBigInt`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>\> : `_ZodBigInt`\<`T`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `_ZodBigInt`\<`T`\> & [`ZodType`](ZodType-1.md)\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>, `$ZodTypeInternals`\<`R`, [`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>\> : `_ZodBigInt`\<`T`\>
...
...`_ZodBigInt`\<`T`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `_ZodBigInt`\<`T`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `_ZodBigInt`\<`T`\>\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`_ZodBigInt`\<`T`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`_ZodBigInt`\<`T`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`_ZodBigInt`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>
...
[`ZodPipe`](ZodPipe.md)\<`_ZodBigInt`\<`T`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, [`output`](../namespaces/core/type-aliases/output.md)\<`_ZodBigInt`\<`T`\>\>\>\>
