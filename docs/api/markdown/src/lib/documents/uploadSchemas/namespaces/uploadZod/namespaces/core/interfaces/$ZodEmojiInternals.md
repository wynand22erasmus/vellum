...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:176

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"emoji"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"emoji"`\>
