...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:258
...
> **\_zod**: [`$ZodISODateTimeInternals`]($ZodISODateTimeInternals.md)
...
> **~standard**: [`$ZodStandardSchema`](../type-aliases/$ZodStandardSchema.md)\<`$ZodISODateTime`\>
