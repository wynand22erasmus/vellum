# Interface: $ZodNanoIDInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:184

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"nanoid"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"nanoid"`\>
