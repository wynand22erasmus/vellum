...
> `const` **safeEncode**: \<`T`\>(`schema`, `value`, `_ctx?`) => [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`input`](../namespaces/core/type-aliases/input.md)\<`T`\>\>

Defined in: node\_modules/zod/v4/classic/parse.d.cts:28
