/**
 * Deduplicated browser session probe via `GET /api/auth/me`.
 *
 ...
 *
 * @param signal - Optional abort signal; aborted loads reject and skip shared deduplication
 * @returns Authenticated user or `null` when unauthenticated or on error
 */
