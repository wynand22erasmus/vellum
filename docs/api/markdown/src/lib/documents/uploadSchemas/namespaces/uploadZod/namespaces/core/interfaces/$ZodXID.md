...
> **\_zod**: [`$ZodXIDInternals`]($ZodXIDInternals.md)

Defined in: node\_modules/zod/v4/core/schemas.d.cts:239
...
> **~standard**: [`$ZodStandardSchema`](../type-aliases/$ZodStandardSchema.md)\<`$ZodXID`\>
