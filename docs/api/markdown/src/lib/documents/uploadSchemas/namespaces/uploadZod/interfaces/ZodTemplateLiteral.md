...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:689

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodTemplateLiteralInternals`](../namespaces/core/interfaces/$ZodTemplateLiteralInternals.md)\<`Template`\>\>.[`$ZodTemplateLiteral`](../namespaces/core/interfaces/$ZodTemplateLiteral.md)\<`Template`\>
...
> **\_def**: [`$ZodTemplateLiteralDef`](../namespaces/core/interfaces/$ZodTemplateLiteralDef.md)
...
> **\_zod**: [`$ZodTemplateLiteralInternals`](../namespaces/core/interfaces/$ZodTemplateLiteralInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodTemplateLiteral`\<`Template`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:690
...
> **def**: [`$ZodTemplateLiteralDef`](../namespaces/core/interfaces/$ZodTemplateLiteralDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodTemplateLiteral`\<`Template`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodTemplateLiteral`\<`Template`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodTemplateLiteral`\<`Template`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodTemplateLiteral`\<`Template`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodTemplateLiteral`\<`Template`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodTemplateLiteral`\<`Template`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodTemplateLiteral`\<`Template`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`Template`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`Template`\>)[]
...
[`$ZodTemplateLiteralDef`](../namespaces/core/interfaces/$ZodTemplateLiteralDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`Template`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
[`NoUndefined`](../namespaces/util/type-aliases/NoUndefined.md)\<`Template`\>

##### Returns

[`ZodDefault`](ZodDefault.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`Template`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodTemplateLiteral`\<`Template`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodTemplateLiteral`\<`Template`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodTemplateLiteral`\<`Template`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodTemplateLiteral`\<`Template`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodTemplateLiteral`\<`Template`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodTemplateLiteral`\<`Template`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodTemplateLiteral`\<`Template`\>, `T`\]\>
...
> **parseAsync**(`data`, `params?`): `Promise`\<`Template`\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodTemplateLiteral`\<`Template`\>, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Template`, `$ZodTypeInternals`\<`any`, `Template`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `Template`, `$ZodTypeInternals`\<`any`, `Template`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodTemplateLiteral`\<`Template`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodTemplateLiteral`\<`Template`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodTemplateLiteral`\<`Template`\> & [`ZodType`](ZodType-1.md)\<`R`, `Template`, `$ZodTypeInternals`\<`R`, `Template`\>\> : `ZodTemplateLiteral`\<`Template`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodTemplateLiteral`\<`Template`\> & [`ZodType`](ZodType-1.md)\<`R`, `Template`, `$ZodTypeInternals`\<`R`, `Template`\>\> : `ZodTemplateLiteral`\<`Template`\>
...
...`ZodTemplateLiteral`\<`Template`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodTemplateLiteral`\<`Template`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodTemplateLiteral`\<`Template`\>\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`Template`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodTemplateLiteral`\<`Template`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodTemplateLiteral`\<`Template`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `Template`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodTemplateLiteral`\<`Template`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `Template`\>\>
