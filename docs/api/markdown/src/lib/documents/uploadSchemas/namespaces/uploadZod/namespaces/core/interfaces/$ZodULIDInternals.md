# Interface: $ZodULIDInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:228

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"ulid"`\>

## Properties

### def

> **def**: [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"ulid"`\>
