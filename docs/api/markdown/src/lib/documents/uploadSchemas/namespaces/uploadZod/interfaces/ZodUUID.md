...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:185

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"uuid"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"uuid"`\>
...
> **\_zod**: [`$ZodUUIDInternals`](../namespaces/core/interfaces/$ZodUUIDInternals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:186
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodUUID`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"uuid"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodUUID`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodUUID`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodUUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodUUID`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodUUID` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodUUID`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodUUID` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodUUID`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodUUID`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"uuid"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodUUID`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodUUID`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodUUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodUUID`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodUUID`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodUUID`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodUUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodUUID`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodUUID`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodUUID`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodUUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodUUID`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodUUID`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodUUID`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodUUID`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodUUID`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodUUID`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodUUID`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodUUID`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodUUID` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodUUID`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodUUID` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodUUID`
...
...`ZodUUID` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodUUID`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodUUID`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodUUID`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodUUID`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodUUID`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodUUID`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
