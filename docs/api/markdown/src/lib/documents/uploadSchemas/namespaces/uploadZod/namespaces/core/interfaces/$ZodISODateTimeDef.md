# Interface: $ZodISODateTimeDef

Defined in: node\_modules/zod/v4/core/schemas.d.cts:250

## Extends

- [`$ZodStringFormatDef`]($ZodStringFormatDef.md)\<`"datetime"`\>
...
Defined in: node\_modules/zod/v4/core/schemas.d.cts:252
