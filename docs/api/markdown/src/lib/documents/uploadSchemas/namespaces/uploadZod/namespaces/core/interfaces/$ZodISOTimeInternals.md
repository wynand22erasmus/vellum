# Interface: $ZodISOTimeInternals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:273

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"time"`\>

## Properties

### def

> **def**: [`$ZodISOTimeDef`]($ZodISOTimeDef.md)

Defined in: node\_modules/zod/v4/core/schemas.d.cts:274
