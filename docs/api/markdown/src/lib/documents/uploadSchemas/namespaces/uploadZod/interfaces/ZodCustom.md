# Interface: ZodCustom\<O, I\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:736

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodCustomInternals`](../namespaces/core/interfaces/$ZodCustomInternals.md)\<`O`, `I`\>\>.[`$ZodCustom`](../namespaces/core/interfaces/$ZodCustom.md)\<`O`, `I`\>
...
> **\_def**: [`$ZodCustomDef`](../namespaces/core/interfaces/$ZodCustomDef.md)\<`unknown`\>
...
> **\_zod**: [`$ZodCustomInternals`](../namespaces/core/interfaces/$ZodCustomInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCustom`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:737
...
> **def**: [`$ZodCustomDef`](../namespaces/core/interfaces/$ZodCustomDef.md)\<`unknown`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCustom`\<`O`, `I`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCustom`\<`O`, `I`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCustom`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCustom`\<`O`, `I`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCustom`\<`O`, `I`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCustom`\<`O`, `I`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCustom`\<`O`, `I`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodCustom`\<`O`, `I`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodCustom`\<`O`, `I`\>\>
...
[`$ZodCustomDef`](../namespaces/core/interfaces/$ZodCustomDef.md)\<`unknown`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCustom`\<`O`, `I`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCustom`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCustom`\<`O`, `I`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCustom`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCustom`\<`O`, `I`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCustom`\<`O`, `I`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCustom`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCustom`\<`O`, `I`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCustom`\<`O`, `I`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCustom`\<`O`, `I`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCustom`\<`O`, `I`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCustom`\<`O`, `I`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCustom`\<`O`, `I`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCustom`\<`O`, `I`\> & [`ZodType`](ZodType-1.md)\<`R`, `I`, `$ZodTypeInternals`\<`R`, `I`\>\> : `ZodCustom`\<`O`, `I`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCustom`\<`O`, `I`\> & [`ZodType`](ZodType-1.md)\<`R`, `I`, `$ZodTypeInternals`\<`R`, `I`\>\> : `ZodCustom`\<`O`, `I`\>
...
...`ZodCustom`\<`O`, `I`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCustom`\<`O`, `I`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCustom`\<`O`, `I`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCustom`\<`O`, `I`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCustom`\<`O`, `I`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCustom`\<`O`, `I`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `O`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCustom`\<`O`, `I`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `O`\>\>
