...
> `const` **safeDecodeAsync**: \<`T`\>(`schema`, `value`, `_ctx?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<[`output`](../namespaces/core/type-aliases/output.md)\<`T`\>\>\>

Defined in: node\_modules/zod/v4/classic/parse.d.cts:31
