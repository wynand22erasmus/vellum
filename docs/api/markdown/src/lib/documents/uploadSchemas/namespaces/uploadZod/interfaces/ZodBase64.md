...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:276

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"base64"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"base64"`\>
...
> **\_zod**: [`$ZodBase64Internals`](../namespaces/core/interfaces/$ZodBase64Internals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:277
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodBase64`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"base64"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodBase64`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodBase64`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodBase64`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodBase64`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodBase64` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodBase64`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodBase64` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodBase64`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodBase64`\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodBase64`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"base64"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodBase64`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodBase64`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodBase64`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodBase64`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodBase64`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodBase64`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodBase64`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodBase64`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodBase64`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodBase64`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodBase64`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodBase64`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodBase64`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodBase64`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodBase64`, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodBase64`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodBase64`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodBase64`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodBase64`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodBase64`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodBase64` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodBase64`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodBase64` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodBase64`
...
...`ZodBase64` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodBase64`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodBase64`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodBase64`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodBase64`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodBase64`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodBase64`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
