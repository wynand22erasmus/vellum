...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:408

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodAnyInternals`](../namespaces/core/interfaces/$ZodAnyInternals.md)\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodAnyDef`](../namespaces/core/interfaces/$ZodAnyDef.md)
...
> **\_zod**: [`$ZodAnyInternals`](../namespaces/core/interfaces/$ZodAnyInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodAny`\>
...
> **def**: [`$ZodAnyDef`](../namespaces/core/interfaces/$ZodAnyDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodAny`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodAny`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodAny`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodAny`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodAny` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodAny`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodAny` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodAny`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodAny`\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`any`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`any`\>)[]
...
[`$ZodAnyDef`](../namespaces/core/interfaces/$ZodAnyDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`any`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodAny`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodAny`\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`any`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodAny`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodAny`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodAny`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodAny`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodAny`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodAny`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodAny`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodAny`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodAny`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodAny`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodAny`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodAny`, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `any`, `$ZodTypeInternals`\<`any`, `any`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `any`, `$ZodTypeInternals`\<`any`, `any`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodAny`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodAny`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodAny`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodAny`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodAny`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodAny` & [`ZodType`](ZodType-1.md)\<`R`, `any`, `$ZodTypeInternals`\<`R`, `any`\>\> : `ZodAny`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodAny` & [`ZodType`](ZodType-1.md)\<`R`, `any`, `$ZodTypeInternals`\<`R`, `any`\>\> : `ZodAny`
...
...`ZodAny` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodAny`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodAny`\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`any`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodAny`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodAny`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodAny`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `any`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodAny`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `any`\>\>
