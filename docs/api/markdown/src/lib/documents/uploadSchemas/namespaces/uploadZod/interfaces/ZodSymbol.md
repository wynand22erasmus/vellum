...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:394

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodSymbolInternals`](../namespaces/core/interfaces/$ZodSymbolInternals.md)\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodSymbolDef`](../namespaces/core/interfaces/$ZodSymbolDef.md)
...
> **\_zod**: [`$ZodSymbolInternals`](../namespaces/core/interfaces/$ZodSymbolInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodSymbol`\>
...
> **def**: [`$ZodSymbolDef`](../namespaces/core/interfaces/$ZodSymbolDef.md)
...
> **spa**: (`data`, `params?`) => `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>\>
...
`Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodSymbol`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodSymbol`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodSymbol` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodSymbol`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodSymbol` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodSymbol`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodSymbol`\>
...
...([`CheckFn`](../namespaces/core/type-aliases/CheckFn.md)\<`symbol`\> \| [`$ZodCheck`](../namespaces/core/interfaces/$ZodCheck.md)\<`symbol`\>)[]
...
[`$ZodSymbolDef`](../namespaces/core/interfaces/$ZodSymbolDef.md)
...
> **decodeAsync**(`data`, `params?`): `Promise`\<`symbol`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodSymbol`\>
...
> **encodeAsync**(`data`, `params?`): `Promise`\<`symbol`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodSymbol`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodSymbol`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodSymbol`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodSymbol`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodSymbol`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodSymbol`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodSymbol`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodSymbol`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodSymbol`, `T`\>
...
`T` *extends* [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `symbol`, `$ZodTypeInternals`\<`any`, `symbol`\>\>

#### Parameters

##### target

`T` \| [`$ZodType`](../namespaces/core/interfaces/$ZodType-1.md)\<`any`, `symbol`, `$ZodTypeInternals`\<`any`, `symbol`\>\>

#### Returns

[`ZodPipe`](ZodPipe.md)\<`ZodSymbol`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodSymbol`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodSymbol`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodSymbol`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodSymbol` & [`ZodType`](ZodType-1.md)\<`R`, `symbol`, `$ZodTypeInternals`\<`R`, `symbol`\>\> : `ZodSymbol`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodSymbol` & [`ZodType`](ZodType-1.md)\<`R`, `symbol`, `$ZodTypeInternals`\<`R`, `symbol`\>\> : `ZodSymbol`
...
...`ZodSymbol` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodSymbol`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodSymbol`\>\] : \[`"Incompatible schema"`\]
...
> **safeDecode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>
...
[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>
...
> **safeDecodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>\>
...
> **safeEncode**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>
...
> **safeEncodeAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>\>
...
> **safeParse**(`data`, `params?`): [`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>
...
> **safeParseAsync**(`data`, `params?`): `Promise`\<[`ZodSafeParseResult`](../type-aliases/ZodSafeParseResult.md)\<`symbol`\>\>
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodSymbol`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodSymbol`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodSymbol`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `symbol`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodSymbol`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `symbol`\>\>
