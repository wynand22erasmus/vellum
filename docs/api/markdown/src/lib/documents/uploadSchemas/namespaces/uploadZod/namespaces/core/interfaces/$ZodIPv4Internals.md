# Interface: $ZodIPv4Internals

Defined in: node\_modules/zod/v4/core/schemas.d.cts:291

## Extends

- [`$ZodStringFormatInternals`]($ZodStringFormatInternals.md)\<`"ipv4"`\>

## Properties

### def

> **def**: [`$ZodIPv4Def`]($ZodIPv4Def.md)
