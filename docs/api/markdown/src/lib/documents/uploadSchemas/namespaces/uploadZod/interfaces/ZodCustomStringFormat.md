...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:296

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`Format`\>.[`$ZodCustomStringFormat`](../namespaces/core/interfaces/$ZodCustomStringFormat.md)\<`Format`\>
...
> **\_zod**: [`$ZodCustomStringFormatInternals`](../namespaces/core/interfaces/$ZodCustomStringFormatInternals.md)\<`Format`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:297
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodCustomStringFormat`\<`Format`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:298
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodCustomStringFormat`\<`Format`\>, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodCustomStringFormat`\<`Format`\>, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodCustomStringFormat`\<`Format`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodCustomStringFormat`\<`Format`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCustomStringFormat`\<`Format`\>, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodCustomStringFormat`\<`Format`\> : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodCustomStringFormat`\<`Format`\>, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodCustomStringFormat`\<`Format`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodCustomStringFormat`\<`Format`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCustomStringFormat`\<`Format`\>\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodCustomStringFormat`\<`Format`\>\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodCustomStringFormat`\<`Format`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodCustomStringFormat`\<`Format`\>, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodCustomStringFormat`\<`Format`\>, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodCustomStringFormat`\<`Format`\>, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCustomStringFormat`\<`Format`\>, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodCustomStringFormat`\<`Format`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodCustomStringFormat`\<`Format`\> & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodCustomStringFormat`\<`Format`\>
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodCustomStringFormat`\<`Format`\> & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodCustomStringFormat`\<`Format`\>
...
...`ZodCustomStringFormat`\<`Format`\> *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCustomStringFormat`\<`Format`\>\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodCustomStringFormat`\<`Format`\>\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodCustomStringFormat`\<`Format`\>\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodCustomStringFormat`\<`Format`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodCustomStringFormat`\<`Format`\>, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
