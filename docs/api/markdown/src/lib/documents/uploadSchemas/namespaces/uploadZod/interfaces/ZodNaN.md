...
Defined in: node\_modules/zod/v4/classic/schemas.d.cts:654

## Extends

- [`_ZodType`](ZodType.md)\<[`$ZodNaNInternals`](../namespaces/core/interfaces/$ZodNaNInternals.md)\>.[`$ZodNaN`](../namespaces/core/interfaces/$ZodNaN.md)

## Properties

### ~~\_def~~

> **\_def**: [`$ZodNaNDef`](../namespaces/core/interfaces/$ZodNaNDef.md)
...
> **\_zod**: [`$ZodNaNInternals`](../namespaces/core/interfaces/$ZodNaNInternals.md)
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodNaN`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:655
...
> **def**: [`$ZodNaNDef`](../namespaces/core/interfaces/$ZodNaNDef.md)
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodNaN`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodNaN`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodNaN`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodNaN`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodNaN` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNaN`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodNaN` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodNaN`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodNaN`\>
...
[`$ZodNaNDef`](../namespaces/core/interfaces/$ZodNaNDef.md)
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodNaN`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodNaN`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodNaN`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodNaN`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodNaN`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodNaN`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodNaN`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodNaN`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodNaN`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodNaN`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodNaN`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodNaN`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodNaN`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodNaN`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodNaN`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodNaN`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodNaN`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodNaN`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodNaN` & [`ZodType`](ZodType-1.md)\<`R`, `number`, `$ZodTypeInternals`\<`R`, `number`\>\> : `ZodNaN`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodNaN` & [`ZodType`](ZodType-1.md)\<`R`, `number`, `$ZodTypeInternals`\<`R`, `number`\>\> : `ZodNaN`
...
...`ZodNaN` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNaN`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodNaN`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNaN`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodNaN`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodNaN`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `number`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodNaN`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `number`\>\>
