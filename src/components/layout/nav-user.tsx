/**
 * Sidebar account menu for signed-in users.
 *
...
import { displayUserName } from '@/lib/sidebar-nav';
import type { Theme } from '@/lib/theme';

/** Show profile details, theme controls, and sign-out in the sidebar footer. */
export function NavUser({ user, onSignOut }: { user: AuthUser; onSignOut: () => void }) {
