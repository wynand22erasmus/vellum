# Interface: ZodBase64URL

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:281

## Extends

- [`ZodStringFormat`](ZodStringFormat.md)\<`"base64url"`\>

## Properties

### ~~\_def~~

> **\_def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"base64url"`\>
...
> **\_zod**: [`$ZodBase64URLInternals`](../namespaces/core/interfaces/$ZodBase64URLInternals.md)

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:282
...
> **~standard**: [`ZodStandardSchemaWithJSON`](../type-aliases/ZodStandardSchemaWithJSON.md)\<`ZodBase64URL`\>
...
> **def**: [`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"base64url"`\>
...
> **and**\<`T`\>(`incoming`): [`ZodIntersection`](ZodIntersection.md)\<`ZodBase64URL`, `T`\>
...
[`ZodIntersection`](ZodIntersection.md)\<`ZodBase64URL`, `T`\>
...
> **array**(): [`ZodArray`](ZodArray.md)\<`ZodBase64URL`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:50

#### Returns

[`ZodArray`](ZodArray.md)\<`ZodBase64URL`\>
...
> **brand**\<`T`, `Dir`\>(`value?`): `PropertyKey` *extends* `T` ? `ZodBase64URL` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodBase64URL`, `T`, `Dir`\>
...
`PropertyKey` *extends* `T` ? `ZodBase64URL` : [`$ZodBranded`](../namespaces/core/type-aliases/$ZodBranded.md)\<`ZodBase64URL`, `T`, `Dir`\>
...
> **catch**(`def`): [`ZodCatch`](ZodCatch.md)\<`ZodBase64URL`\>
...
[`ZodCatch`](ZodCatch.md)\<`ZodBase64URL`\>
...
[`$ZodStringFormatDef`](../namespaces/core/interfaces/$ZodStringFormatDef.md)\<`"base64url"`\>
...
> **default**(`def`): [`ZodDefault`](ZodDefault.md)\<`ZodBase64URL`\>
...
[`ZodDefault`](ZodDefault.md)\<`ZodBase64URL`\>
...
> **exactOptional**(): [`ZodExactOptional`](ZodExactOptional.md)\<`ZodBase64URL`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:42

#### Returns

[`ZodExactOptional`](ZodExactOptional.md)\<`ZodBase64URL`\>
...
> **nonoptional**(`params?`): [`ZodNonOptional`](ZodNonOptional.md)\<`ZodBase64URL`\>
...
[`ZodNonOptional`](ZodNonOptional.md)\<`ZodBase64URL`\>
...
> **nullable**(): [`ZodNullable`](ZodNullable.md)\<`ZodBase64URL`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:44

#### Returns

[`ZodNullable`](ZodNullable.md)\<`ZodBase64URL`\>
...
> **nullish**(): [`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodBase64URL`\>\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:45

#### Returns

[`ZodOptional`](ZodOptional.md)\<[`ZodNullable`](ZodNullable.md)\<`ZodBase64URL`\>\>
...
> **optional**(): [`ZodOptional`](ZodOptional.md)\<`ZodBase64URL`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:41

#### Returns

[`ZodOptional`](ZodOptional.md)\<`ZodBase64URL`\>
...
> **or**\<`T`\>(`option`): [`ZodUnion`](ZodUnion.md)\<\[`ZodBase64URL`, `T`\]\>
...
[`ZodUnion`](ZodUnion.md)\<\[`ZodBase64URL`, `T`\]\>
...
> **pipe**\<`T`\>(`target`): [`ZodPipe`](ZodPipe.md)\<`ZodBase64URL`, `T`\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodBase64URL`, `T`\>
...
> **prefault**(`def`): [`ZodPrefault`](ZodPrefault.md)\<`ZodBase64URL`\>
...
[`ZodPrefault`](ZodPrefault.md)\<`ZodBase64URL`\>
...
> **readonly**(): [`ZodReadonly`](ZodReadonly.md)\<`ZodBase64URL`\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:57

#### Returns

[`ZodReadonly`](ZodReadonly.md)\<`ZodBase64URL`\>
...
> **refine**\<`Ch`\>(`check`, `params?`): `Ch` *extends* (`arg`) => `arg is R` ? `ZodBase64URL` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodBase64URL`
...
`Ch` *extends* (`arg`) => `arg is R` ? `ZodBase64URL` & [`ZodType`](ZodType-1.md)\<`R`, `string`, `$ZodTypeInternals`\<`R`, `string`\>\> : `ZodBase64URL`
...
...`ZodBase64URL` *extends* `R`\[`"_schema"`\] ? `undefined` *extends* `R`\[`"_meta"`\] ? \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodBase64URL`\>?\] : \[[`$replace`](../namespaces/core/type-aliases/$replace.md)\<`R`\[`"_meta"`\], `R`\[`"_schema"`\] & `ZodBase64URL`\>\] : \[`"Incompatible schema"`\]
...
> **toJSONSchema**(`params?`): [`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodBase64URL`\>
...
[`ZodStandardJSONSchemaPayload`](../namespaces/core/interfaces/ZodStandardJSONSchemaPayload.md)\<`ZodBase64URL`\>
...
> **transform**\<`NewOut`\>(`transform`): [`ZodPipe`](ZodPipe.md)\<`ZodBase64URL`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
...
[`ZodPipe`](ZodPipe.md)\<`ZodBase64URL`, [`ZodTransform`](ZodTransform.md)\<`Awaited`\<`NewOut`\>, `string`\>\>
