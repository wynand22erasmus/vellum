...
> **looseObject**\<`T`\>(`shape`, `params?`): [`ZodObject`](../interfaces/ZodObject.md)\<\{ -readonly \[P in string \| number \| symbol\]: T\[P\] \}, [`$loose`](../namespaces/core/type-aliases/$loose.md)\>

Defined in: node\_modules/zod/v4/classic/schemas.d.cts:492
...
[`ZodObject`](../interfaces/ZodObject.md)\<\{ -readonly \[P in string \| number \| symbol\]: T\[P\] \}, [`$loose`](../namespaces/core/type-aliases/$loose.md)\>
